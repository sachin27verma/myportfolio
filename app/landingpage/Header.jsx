...
const Header = () => {
        ...
        <div className="flex justify-between items-center py-2 px-3">
          ...
          <div className="hidden md:flex justify-around items-center w-[40%]">
            ...
            <div className="p-2 border-2 border-gray-100 bg-gray-100 rounded-md shadow-md hover:shadow-lg cursor-pointer transition-transform transform hover:scale-105">
              <Link href="https://drive.google.com/file/d/1cMOHm4n938q30HXm1jC3MhdeF_z4mj47/view?usp=sharing">
  ...
  <ul className="list-none flex flex-col md:flex-row gap-4 w-full md:w-auto">
    ...
    <li className="list-disc mt-2">
      <Link href="https://drive.google.com/file/d/1cMOHm4n938q30HXm1jC3MhdeF_z4mj47/view?usp=sharing" className="font-semibold cursor-pointer hover:scale-105 hover:text-yellow-300 transition-transform">
